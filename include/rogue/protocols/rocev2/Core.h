 ...
 * ----------------------------------------------------------------------------
 * Description:
 * RoCEv2 Core - base class holding ibverbs resources shared by Server.
 * ----------------------------------------------------------------------------
...
#ifndef ROGUE_PROTOCOLS_ROCEV2_CORE_H
#define ROGUE_PROTOCOLS_ROCEV2_CORE_H
...
class Core {
  protected:
    ...
    struct ibv_cq*      cq_;    // completion queue
    struct ibv_qp*      qp_;    // queue pair (UD type)
    struct ibv_mr*      mr_;    // memory region covering the whole pool slab
...
#endif  // ROGUE_PROTOCOLS_ROCEV2_CORE_H
